...
<div class="layout-wrapper clearfix">
                <div class="content-layout">
                    <H1 align ="center">ISSUING A PARCEL </h1>
					<form action="issue.php" method="post" name="getparcel" id="getparcel">
    
      <table width="492" align="center" id="table">
      <tr>
        <td colspan="2" align="center"bgcolor="#FF9966"><label><strong>Enter parcel number from the label</strong></label>&nbsp;</td>
        </tr>
                <tr>
          <td width="" align="right">NUMBER:</td>
          <td width="186"><label>
            <input name="txtnumber" type="text"  id="txtnumber" value="" size="30"/>
          </label></td>
        </tr>
        <tr>
          <td align="right">&nbsp;</td>
          <td><label></label>
              ...
              <label> </label>
              <label>
              <input type="submit" name="getparcel" id="getparcel" value="Submit" />
              </label>
              <label></label></td>
        </tr>
      </table>
	...
	<hr color="#6699CC"></hr>
			...
			<h1 align="center"><a href="viewdelivered.php"><image src="images/delivered.png" </a><h1>
...
<p>Copyright © 2013. All Rights Reserved. MUTUMA DICKSON EDWARD</p>
</footer>
