...
<div class="layout-wrapper clearfix">
	 ...
	 $query="INSERT INTO parcels (parcelid, type, senderid, destination) values('".$parcelid."', '".$type."', '".$senderid."', '".$destination."')";
		
		  if(!mysql_query($query,$link))
		  {die ("An unexpected error occured while saving the record, Please check your input and try again!");}
		  else
		 {
		  echo "New parcel added successfully!";}
	 ?>
<p align="center"><img onclick="javascript: history.go(-1)" src="images/back.png"/><!--<a href="../"><img border="0" src="images/back.png" /></a>--></p>
