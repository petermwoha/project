...
function menuExtendedCreate() {
    ...
    // reset
    jQuery("#menu-style").remove();

    var styleStr = "";
    var style = jQuery("<style id=\"menu-style\"></style>").appendTo('head');
    ...
    jQuery(".hmenu>li").each(function(i, v) {
        ...
        if (subm.length > 0) {
            ...
            if (style !== null && typeof style.insertRule !== "undefined") {
                var cls = "hmenu-item-" + i;
                var selector = ".desktop ul.hmenu>li." + cls + ":hover>ul:before";
                var r = submWidth;
...
jQuery(function ($) {
    ...
    var header = $(".header");
    var bgimages = "url('images/object1653573481.png'), ".split(",");
    var bgpositions = "243px 0px, ".split(",");
