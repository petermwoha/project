...
<div class="layout-wrapper clearfix">
                ...
                <div align="center">
                     <br>
                     <a href="searching1.php">Sent From your station.</a>
                             <a href="searching.php">Sent to your Station.</a> <br>


                    <br><H3 align ="center"><u>View Parcels sent from your station.</u></h3> <br>
                    
                    <form action="searching1.php" method="POST">
...
<table border="1" width="90%">
 <tr>
  ...
  <th align="center">Destination Town</th>
  ...
  {
    $dest = $_POST['source'];
     $query = "SELECT * FROM parcels where source='$dest'";
