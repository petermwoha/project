...
<nav class="nav clearfix">
    <ul class="hmenu"><li><a href="main.php" >Home</a></li><li><a href="#" class="active">Add a parcel</a></li><li><a href="r_parcel.php">Receive a parcel</a></li><li><a href="i_parcel.php" >Issue parcel</a></li><li><a href="senders.php">Senders</a></li><li><a href="recepients.php">Recepients</a></li></ul> 
    </nav>
<div class="layout-wrapper clearfix">
   ...
   error_reporting(E_ALL ^ E_NOTICE);
	 ...
	 $query="INSERT INTO senders (idnumber, name, mobile) values('".$id."', '".$name."', '".$mobile."')";
		
		  if(!mysql_query($query,$link))
		  {die ("CHECK YOUR INPUT for  UNFILLED VALUES ,DUPLICATES IDs OR PARCEL IDs and try again!");}
		  else
		 {
		  echo "New sender added successfully!";}
	 ?>
