...
<div class="layout-wrapper clearfix">
   ...
   <?php 
	 ...
	 $receipient=$_POST['rname']; 
	 $link=mysql_connect("localhost","root","") or die("Cannot Connect to the database!");
	
	 mysql_select_db("datarush",$link) or die ("Cannot select the database!");
	 $query="INSERT INTO parcels (type, senderid, destination,source,idnumber,mobile,sendername,receipientname) values('".$type."', '".$senderid."', '".$destination."','".$source."','".$idnumber."','".$mobile."','".$sendername."','".$receipient."')";
